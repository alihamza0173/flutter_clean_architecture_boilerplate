...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PostModel&&super == other&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.userId, _this.userId) || other.userId == _this.userId)&&(identical(other.title, _this.title) || other.title == _this.title)&&(identical(other.body, _this.body) || other.body == _this.body));
}
...
int get hashCode {
  final _this = this as PostModel;
  return Object.hash(runtimeType,super.hashCode,_this.id,_this.userId,_this.title,_this.body);
}
...
class _PostModel extends PostModel {
  const _PostModel({required this.id, required this.userId, required this.title, required this.body}): super._();
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _PostModel&&super == other&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.title, title) || other.title == title)&&(identical(other.body, body) || other.body == body));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,super.hashCode,id,userId,title,body);
}
